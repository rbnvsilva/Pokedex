...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    pokedexNumber = req_body.get('pokedexNumber')
    ...
    try:
        entityWithSamePokedexNumber = table_client.query_entities(
            "PokedexNumber eq {}".format(entityToInsert['PokedexNumber']))
